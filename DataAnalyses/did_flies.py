...
input_deviations_0 = total_input_fr[:,15,:]
input_deviations_1 = total_input_fr[:,25,:]
...
pos_fp_deviations = deviations_fp[idx_pos]

fig, axs = plt.subplots(1,1,figsize=(3,3))
axs.spines[['top','right']].set_visible(False)
axs.scatter(total_input_fr[:,15,5], deviations_fp, color='k',s=5)
...
plt.tight_layout()
fig.savefig(os.path.join(output_figures, 'DiDFlies.png'),bbox_inches='tight')
fig.savefig(os.path.join(output_figures, 'DiDFlies.svg'),bbox_inches='tight')
